...
// Load secrets/keys from .env (kept out of source control). Minimal
// zero-dependency parser; any value already present in process.env wins,
// so real environment overrides are respected.
(() => {
  try {
